...
function escribir(){
  ...
  //tomando como referencia el documento invocamos el elemento por el id con nombre respuesta1 para introducir la respuesta obtenida
    document.getElementById('respuesta1').innerHTML='Zure izena zuriunerik gabeko karaktere kopurua hau da:'+ "   "   +  cuentaCaracter + " <br/> "+  
    "Izena : " +  arrayLoIntroducido[0] + " <br/> "+  " Abizena 1:  " + arrayLoIntroducido[1] + " <br/> "+  "Abizena 2:  " +  arrayLoIntroducido[2]   ;
  ...
  document.getElementById('edad').innerHTML="Zure adina da :  " + edad + "  urte" ;//imprime en el documento en el div con id edad el resultado
  }
  ...
  alert("Zenbaki altuena  " +  mayor + "da");// crea una ventana de alerta con el contenido de la variable mayor
  }
  ...
  function abrirVentana(){
    let subVentana = window.open("leaflet.html", "mapa Estella", "height=800, width=600");//variable que contiene a el html
  }
